    ...
    return (
        <div id="sub-page">
            <Button onClick={async () => {
                await modalActions.createModal("MODAL_TYPE_ALERT",
            ...
            <Button onClick={async () => {
                await modalActions.createModal("MODAL_TYPE_WOW",
                    { title: "Are you sure?", content: "Are you sure about that? You think half about it. Just stop your crying It's a sign of the times Welcome to the final show Hope you're wearing your best clothes You can't bribe the door on your way to the sky You look pretty good down here But you ain't really good" },
                    { hello: 'yeah' })
            }}>WOW Modal</Button>
            <Button onClick={async () => {
                await modalActions.createModal("MODAL_TYPE_CONFIRM",
                    { title: "Are you sure?", content: "Are you sure about that? You think half about it. Just stop your crying It's a sign of the times Welcome to the final show Hope you're wearing your best clothes You can't bribe the door on your way to the sky You look pretty good down here But you ain't really good" },
                )
            }}>Confirm Modal</Button>
            <Button onClick={async () => {
                await modalActions.createModal("MODAL_TYPE_PROMPT",
            ...
            <Button onClick={() => {
                modalActions.createModal("MODAL_TYPE_LOADING"); setTimeout(async () => {
                    await modalActions.popModal()
                    await modalActions.createModal("MODAL_TYPE_ALERT",
                        { title: "Are you sure?", content: "Are you sure about that? You think half about it. Just stop your crying It's a sign of the times Welcome to the final show Hope you're wearing your best clothes You can't bribe the door on your way to the sky You look pretty good down here But you ain't really good" },
                    )
                }, 2000);
